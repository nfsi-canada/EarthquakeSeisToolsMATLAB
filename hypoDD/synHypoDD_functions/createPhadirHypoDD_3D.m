function [phadir0,phadir1,T1] = createPhadirHypoDD_3D(hyp0,hyp1,T0,sta,model,vpvs,NF0,NF1)
% function [phadir,phadir1,T1] = createPhadirHypoDD_3D(hyp0,hyp1,T0,sta,model,vpvs,NF0,NF1)
% 
% 2021-01-11
...
t0 = RayTrace3D(H0(upha(:,1),:),S(upha(:,2),:),model.V,3,10); 
t1 = RayTrace3D(H1(upha(:,1),:),S(upha(:,2),:),model.V,3,10);
