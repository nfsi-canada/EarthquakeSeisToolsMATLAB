function [sdr1,sdr2,errPHI] = solveDC_L2(X,Prob,gP,gT,gI)
% function [sdr1,sdr2,errPHI] = solveDC_L2(X,Prob,gP,gT,gI)
%
% 2020-07-20
% This function finds the focal mechanism that minimizes the L2
% error angle (standard deviation). This requires
